...
- `CloudLibraryLibraryScreen` (includes inline library search)
- `CloudLibraryConsolesView`

It also applies load-state gating before library content renders, so those screens do not need to duplicate the shell-wide loading and cached-data logic.
