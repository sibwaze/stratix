...
final class CloudLibraryViewModelSceneMutationTests: XCTestCase {
    ...
    func testCloudLibraryViewModelBuildsHeroBackgroundContextFromCachedState() {
        ...
        XCTAssertEqual(changedContext.inputs.route, CloudLibrarySceneModel.HeroBackgroundRoute.library)
        XCTAssertEqual(changedContext.inputs.libraryHeroBackgroundURL, URL(string: "https://example.com/fallback-library-hero.png"))
