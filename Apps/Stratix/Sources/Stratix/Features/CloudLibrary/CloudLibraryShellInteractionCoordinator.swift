...
struct CloudLibraryShellInteractionCoordinator {
    ...
    func openDetail(
        ...
        NavigationPerformanceTracker.recordRouteChange(
            from: routeState.browseRoute.rawValue,
    ...
    func selectPrimaryRoute(
        ...
        if targetRoute != .library {
            ...
            if queryState.wrappedValue.isLibrarySearchActive {
                queryState.wrappedValue.isLibrarySearchActive = false
                queryState.wrappedValue.searchText = ""
            }
        }
    ...
    /// Opens settings on the stream pane so every settings entry path lands on the same root surface.
    func openSettingsUtility(
        ...
        selectedSettingsPane.wrappedValue = .stream
        focusState.isSideRailExpanded = false
    ...
    func handleBack(
        ...
        case .closeUtilityRoute:
            ...
            NavigationPerformanceTracker.recordRouteChange(
                ...
                to: routeState.browseRoute.rawValue,
