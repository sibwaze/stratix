...
public final class LibraryController {
    ...
    @ObservationIgnored weak var shellBootstrapController: ShellBootstrapController?
    ...
    init(
        ...
        let resolvedRepository = libraryRepository ?? LazyLibraryRepository(
...
struct LibraryHydrationConfig: Sendable {
    static let shared = LibraryHydrationConfig()
