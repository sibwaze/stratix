...
public final class SettingsStore {
    ...
    public struct StreamSettings: Sendable, Equatable {
        ...
        public init(
            ...
            self.idleDisconnectMinutes = SettingsStore.normalizedIdleDisconnectMinutes(idleDisconnectMinutes)
    ...
    private enum Key {
        ...
        static let idleDisconnectMinutes = "guide.idle_disconnect_minutes"
    ...
    private nonisolated(unsafe) static let registeredDefaultsValues: [String: Any] = [
    ...
    public init(defaults: UserDefaults = .standard) {
        ...
        self.didMigrateLegacyStatsHUDThisLaunch = Self.migrateLegacyStatsHUDKey(defaults: defaults)
    ...
    private func persist(_ value: StreamSettings, oldValue: StreamSettings) {
        ...
        defaults.set(
            Self.normalizedIdleDisconnectMinutes(value.idleDisconnectMinutes),
            forKey: Key.idleDisconnectMinutes
        )
    ...
    private nonisolated static func readStream(from defaults: UserDefaults) -> StreamSettings {
        ...
        return StreamSettings(
            ...
            idleDisconnectMinutes: Self.normalizedIdleDisconnectMinutes(
                int(defaults, Key.idleDisconnectMinutes, fallback: 30)
            ),
    ...
    private nonisolated static func int(_ defaults: UserDefaults, _ key: String, fallback: Int) -> Int {
        (defaults.object(forKey: key) as? Int) ?? fallback
    }

    nonisolated static func normalizedIdleDisconnectMinutes(_ value: Int) -> Int {
        switch value {
        case 15:
            return 15
        default:
    ...
    private nonisolated static func migrateLegacyStatsHUDKey(
        ...
        let hasExplicitGuideStatsValue = defaults.object(forKey: Key.showStreamStats) != nil
    ...
    private nonisolated static func migrateLegacyUpscalingEnabled(defaults: UserDefaults) -> Bool {
        ...
        let hasExplicitUpscalingValue = defaults.object(forKey: Key.upscalingEnabled) != nil
