...
enum AppControllerBuilder {
    private static let startupWorkflow = AppStartupWorkflow()
    private static let foregroundRefreshWorkflow = AppForegroundRefreshWorkflow()
    private static let backgroundRefreshWorkflow = AppBackgroundRefreshWorkflow()
    private static let cacheRestoreWorkflow = AppCacheRestoreWorkflow()
    private static let signOutWorkflow = AppSignOutWorkflow()
    ...
    static func make(settingsStore: SettingsStore) -> AppControllerGraph {
        ...
        let lifecycleCoordinator = AppLifecycleCoordinator(
            ...
            achievementsController: achievementsController,
            startupWorkflow: Self.startupWorkflow,
            foregroundRefreshWorkflow: Self.foregroundRefreshWorkflow,
            backgroundRefreshWorkflow: Self.backgroundRefreshWorkflow,
            signOutWorkflow: Self.signOutWorkflow
        )
        let shellBootCoordinator = AppShellBootCoordinator(
            ...
            shellBootstrapController: shellBootstrapController,
            achievementsController: achievementsController,
            cacheRestoreWorkflow: Self.cacheRestoreWorkflow,
            startupWorkflow: Self.startupWorkflow,
